...
void Initialize() {
    ...
    SwitchToScene(sceneList[3]); //to debug remember to switch back to 3
...
void Update() {
    ...
    viewMatrix = glm::mat4(1.0f);
    if (currentScene->state.player->position.x > 5 && (currentScene != sceneList[3] && currentScene != sceneList[4] && currentScene != sceneList[5])) {
